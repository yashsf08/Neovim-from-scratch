...
-- TODO: Needs to be fixed complete since the update
...
local mappings = {
  ...
  -- Diffview
  { "<leader>d",  group = "DiffView",                                                                                               nowait = true,                  remap = false },
  { "<leader>dc", "<cmd>DiffviewClose<cr>",                                                                                         desc = "close",                 nowait = true, remap = false },
  { "<leader>dh", "<cmd>DiffviewFileHistory<cr>",                                                                                   desc = "History",               nowait = true, remap = false },
  { "<leader>do", "<cmd>DiffviewOpen<cr>",                                                                                          desc = "Open",                  nowait = true, remap = false },
  { "<leader>dr", "<cmd>DiffviewRefresh<cr>",                                                                                       desc = "refresh",               nowait = true, remap = false },
  { "<leader>dt", "<cmd>DiffviewToggleFiles<cr>",                                                                                   desc = "Toggle",                nowait = true, remap = false },
